#' @title NASCAR Xfinity Series Owner Season Statistics
#' @description A collection of season statistics for owners in the NASCAR Xfinity Series. The data includes season totals and averages for various performance metrics.
#' @format A data frame with 3268 rows and 14 variables:
#' \describe{
...
#' @examples
#' data(xfinity_owner_season)
'xfinity_owner_season'
