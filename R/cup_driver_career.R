#' @title NASCAR Cup Series Driver Career Statistics
#' @description A collection of career statistics for drivers in the NASCAR Cup Series. The data includes career averages and totals for various performance metrics.
#' @format A data frame with 2,973 rows and 23 variables:
#' \describe{
