#' @title NASCAR Xfinity Series Owner Career Statistics
#' @description A collection of career statistics for owners in the NASCAR Xfinity Series. The data includes career totals and averages for various performance metrics.
#' @format A data frame with 1241 rows and 13 variables:
#' \describe{
