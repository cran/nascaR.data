#' @title NASCAR truck Series Results
#' @description A collection of NASCAR's pickup truck race series results from the first race in 1995 through the completion of the 2023 season. The series has undergone name changes, originating with the NASCAR Craftsman Truck Series to the Camping World and Gander Outdoors Truck Series and returning to the Craftsman Truck Series.
#' @format A data frame with 23,836 rows and 23 variables:
#' \describe{
#'   \item{season}{num: Racing season (1995-2023)}
#'   \item{race}{num: Chronological race number for that season (1-27)}
...
#'   \item{manufacturer}{chr: Truck manufacturer ("Chevrolet", "Dodge", "Ford", "Toyota", "RAM")}
#'   \item{truck_number}{chr: Truck number}
#'   \item{owner}{chr: Truck owner}
#'   \item{sponsor}{chr: Truck sponsor}
